...
export default function NewProductPage() {
    ...
    const [variants, setVariants] = useState<VariantFormState[]>([{ size: '', color: '', stock: '10', imageUrl: '' }]);
    ...
    const addVariant = () => {
        setVariants([...variants, { size: '', color: '', stock: '10', imageUrl: '' }]);
    };
                        ...
                        <div className="grid auto-rows-max items-start gap-4 lg:col-span-2 lg:gap-8">
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Ajoutez des variantes comme la taille, la couleur et une image spécifique.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                    {variants.map((variant, index) => (
                                        <div key={index} className="space-y-4 mb-4 pb-4 border-b last:border-b-0 last:pb-0 last:mb-0">
